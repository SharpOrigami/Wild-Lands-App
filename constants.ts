...
export const ALL_CARDS_DATA_MAP: { [id: string]: CardData } = {
    ...
    'item_medium_trap_t1': { id: 'item_medium_trap_t1', name: 'Medium Trap', type: 'Item', sellValue: 8, buyCost: 16, effect: {type:'trap', size:'medium'}, description: "A sturdier trap for slightly larger game. Defeats animals up to 6 health." }, 
    
    'item_large_trap_t1': { id: 'item_large_trap_t1', name: 'Large Trap', type: 'Item', sellValue: 12, buyCost: 24, effect: {type:'trap', size:'large'}, description: "A heavy-duty trap for formidable creatures. Defeats animals up to 8 health." }, 
